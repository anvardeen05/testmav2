...
public interface Wrappers {
		 ...
		 * Maximize the browser and set the
		...
		/**
		 * This method will enter the value to the text field 
		 * using name attribute to locate
		 * 
		 ...
		 * @param classname  The classname (locator) of the element to be clicked
		 * @author Babu - TestLeaf
		 * @ 
		 */
		...
		/**
		 * This method will click the element using xpath as locator and do not take snap
		 * @param xpathVal  The xpath (locator) of the element to be clicked
		 * @author Babu - TestLeaf
		 */
		...
		/**
		 * This method will select the last value in drop down using index
		 * @author Babu - TestLeaf
		 */		
		...
		/**
		 * This method will switch to frame the alert opened
		 * @author Babu - TestLeaf
		 */		
